...
# -----------------------------------------
engine_count: 4
engine_make: 4 MAN diesel engines
engine_power: (2x1600 kw; 2x1200 kw)
power_hp: 
aux_diesel_power_hp: 
prop_diameter_m: 
prop_max_rpm: 
...
# -----------------------------------------
navigation_equipment: "2 GPS (DGPS); 2 Radars (X- and S- band); dynamic positioning system; auto-track system; Doppler-log, EM-log"
navigation_gps: 2 GPS (DGPS)
communications: 
satcomm: 
...
# LINKS
# -----------------------------------------
url_vessel: "http://www.ifm.uni-hamburg.de/"
url_operator: "http://www.ifm.uni-hamburg.de/"
url_schedule: 
photo_url: 
