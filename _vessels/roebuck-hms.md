...
vessel_class: 
main_activity: Hydrographic Surveying
ice_class: 
ice_breaking: 
dp_class: 
dp_system: 
...
operator: hydrographic-surveying-squadron
managing_agency: 
operator_contact: 
...
# -----------------------------------------
engine_count: 4
engine_make: Mirrlees Blackstone ES8 MkI diesels
engine_power: 3040 HP
power_hp: 3040
aux_diesel_power_hp: 
prop_diameter_m: 
prop_max_rpm: 
...
# -----------------------------------------
navigation_equipment: Qubit SIPS II integrated navigation and survey system
navigation_gps: Hyperfix and transponder position fixing systems
communications: 
satcomm: 
...
# LINKS
# -----------------------------------------
url_vessel: "http://www.marine.gov.uk/roebuck.htm"
...
notes: 
vessel_other: Passive stabilisation tank
